...
from src.eorbis_docbot.model.conversion_report import ConversionReport, ConversionStatus
...
def run (*, input_dir: Path, output_dir: Path, base_url: str, recursive: bool = True) -> ConversionReport:
    ...
    for md_file in files:
        try:
            ...
            md_converted, images=convert_obsidian_images(md_text, base_url=base_url)
            ...
            report.error.append(ConversionError(file=str(md_file), error=str(e)))
